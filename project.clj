...
(defproject metabase-core "1.0.0-SNAPSHOT"
  ...
  [[org.clojure/clojure "1.10.1"]
   ...
   [com.cloudera/ImpalaJDBC41 "2.6.15"]
  ...
  {:dev
   {:source-paths ["dev/src" "local/src"]
    ...
    :plugins
    [[lein-environ "1.1.0"]
     [lein-pprint "1.3.2"]] ; easy access to environment variables
...
; Re-enable support for unsafe repositories (http only) by putting the following at the end of project.clj file
